  	...
  	<div class="divimage dzsparallaxer--target gradient-overlay-half-dark-v1" style="height: 120%; background-image: url(<?php echo $thumb4['0'];?>);"></div>
    	...
    	<div class="container position-relative z-index-2 space-2 space-3--lg">
      	<div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        	<p style="color: #fff !important"><?php the_content();?></p>
      	</div>
    	</div>
    	<!-- End Content -->
    </div>  
...
<div class="container space-2 space-1--lg">
  ...
  <div class="nav nav-tabs justify-content-center tab-modern mb-5" id="h-tab" role="tablist" aria-orientation="vertical">
    <a class="nav-link h5 active tab-modern__nav-link mb-4" id="h-tab-forward-tab" data-toggle="pill" href="#h-tab-forward" role="tab" aria-controls="h-tab-forward" aria-selected="true">
      <img class="max-width-10 tab-modern__nav-link-icon mx-auto mb-2" src="<?php 
                      ...
                      echo $icon;
                      ?>" alt="Image Description" style="height: 60px; width: 60px">
    ...
    <a class="nav-link h5 tab-modern__nav-link mb-4" id="h-tab-toolsy-1-tab" data-toggle="pill" href="#h-tab-tools-1" role="tab" aria-controls="h-tab-tools-1" aria-selected="false">
      <img class="max-width-10 tab-modern__nav-link-icon mx-auto mb-2" src="<?php 
                      $icon = wp_get_attachment_image_url('1530','iconsMini',true );
                      echo $icon;
                      ?>" alt="Image Description" style="height: 60px; width: 60px">
      <?php //echo the_field('4_enunciado_pregunta_funcionamiento');?>
    </a>
  ...
  $imagen4 = get_field('4_imagen_enunciado_funcionamiento_1');
    ...
    <div class="tab-pane fade" id="h-tab-tools-1" role="tabpanel" aria-labelledby="h-tab-toolsy-1-tab">
      ...
      <div class="row align-items-lg-center">
        <div class="col-md-9 order-md-2 mb-5 mb-md-0">
          <div class="mb-4">
            <!-- Title -->
            <h3><?php echo the_field('4_subtitulo_funcionamiento_1');?> </h3>
            <p><?php echo the_field('4_respuesta_a_enunciado_funcionamiento_1');?></p>
          </div>
        </div>
        <div class="col-md-3 order-md-1">
          <div class="pr-lg-4">
            <img class="img-fluid" src="<?php echo $imagen4['url'];?>" alt="<?php echo $imagen4['alt'];?>" style="display: block; margin-left: auto; margin-right: auto;">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="js-slide">
        ...
        <div class="w-md-80 w-lg-60 text-center mx-auto">
          <div class="mb-4">
            ...
            <hr class="my-2">
            <p class="text-secondary"><?php echo the_field('texto_planes_base');?></p>
          </div>
      ...
      <div class="js-slide">
        ...
        <div class="w-md-80 w-lg-60 text-center mx-auto">
          <div class="mb-4">
            ...
            <hr class="my-2">
            <p class="text-secondary"><?php echo the_field('texto_personalizacion');?></p>
          </div>
...
<div class="container space-1 space-1--lg">
  <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
    ...
    <p>Conoce nuestros Planes Base, los cuales podrás adaptar a tus preferencias, necesidades y presupuesto.</p>
  </div>
  ...
  <div class="nav nav-tabs justify-content-center tab-modern mb-5" id="h-1-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link h5 tab-modern__nav-link mb-4" id="h-tab-toolsy-1-tab" data-toggle="pill" href="#h-tab-toolsy-1" role="tab" aria-controls="h-tab-tools" aria-selected="false">
  ...
  <div class="tab-content" id="h-tabContent-1">
    ...
    <div class="tab-pane fade show active" id="h-tab-forward-1" role="tabpanel" aria-labelledby="h-tab-forward-1-tab">
      ...
      <div class="row align-items-lg-center my-5">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen1_1['url'];?>" alt="<?php echo $imagen1_1['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen1_2['url'];?>" alt="<?php echo $imagen1_2['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen1_3['url'];?>" alt="<?php echo $imagen1_3['alt'];?>" style="height: 80px ; width:80px">
    ...
    <div class="tab-pane fade" id="h-tab-together-1" role="tabpanel" aria-labelledby="h-tab-together-1-tab">
      ...
      <div class="row align-items-lg-center my-5">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen2_1['url'];?>" alt="<?php echo $imagen2_1['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen2_2['url'];?>" alt="<?php echo $imagen2_2['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen2_3['url'];?>" alt="<?php echo $imagen2_3['alt'];?>" style="height: 80px ; width:80px">
    ...
    <div class="tab-pane fade" id="h-tab-toolsy-1" role="tabpanel" aria-labelledby="h-tab-toolsy-1-tab">
     <div class="text-center mx-md-auto">
      ...
      <div class="row align-items-lg-center my-5">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen3_1['url'];?>" alt="<?php echo $imagen3_1['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen3_2['url'];?>" alt="<?php echo $imagen3_2['alt'];?>" style="height: 80px ; width:80px">
        ...
        <div class="col-md-4 mb-1 mb-md-0">
          <div class="bg-white text-center border pt-7 p-5 mb-3 mb-md-0">
            <div class="text-center px-lg-3">
              <img class="max-width-14 mb-2" src="<?php echo $imagen3_3['url'];?>" alt="<?php echo $imagen3_3['alt'];?>" style="height: 80px ; width:80px">
  ...
  <div class="container space-2 space-2--lg">
    <div class="row align-items-lg-center">
      <div class="col-md-9 order-md-2 mb-5 mb-md-0">
        <div class="mb-4">
          <!-- Title -->
          <h3><?php echo the_field('titulo_vuelos');?></h3>
          <p><?php echo the_field('texto_vuelos');?></p>
        </div>
      </div>
      <div class="col-md-3 order-md-1">
        <div class="pr-lg-4">
          <?php $imagenVuelo = get_field('icono_vuelos');?>
          <img class="img-fluid" src="<?php echo $imagenVuelo['url'];?>" alt="<?php echo $imagenVuelo['alt'];?>" style="display: block; margin-left: auto; margin-right: auto;">
        </div>
      </div>
    </div>
  </div>   
