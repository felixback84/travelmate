  ...
  <!-- Article Content -->
 	<div class="container py-3">
		...
		<table class="table table-bordered table-hover"style="width:100%">
            <thead>
                <tr>
	                <th style="width:50%;text-align:center">Transportes</th>
    		...
    		if( have_rows('field_5cbe79ee32eba') ):
				while( have_rows('field_5cbe79ee32eba') ): the_row();

    		$name = get_sub_field('field_5cbf0d80aee9d');
			$file = get_sub_field('field_5cbf0d99aee9e');?>
    	...
    	<div id="signin" data-target-group="idForm">
      	<!-- Title -->
      		<header class="text-center mb-5">
        		<h2 class="h4 mb-0">Confirmación de transportes</h2>
