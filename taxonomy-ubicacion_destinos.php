...
<div class="container space-2 space-1--lg">
  ...
  while(have_posts()){
    the_post();
    $banderaPaises = get_field('bandera_paises'); 
        ...
        <!-- Item -->
      		<div class="cbp-item graphic">
              				...
              				<ul class="list-inline ml-auto p-3 mb-0">
                				...
                				<li class="list-inline-item">
                  					<a class="cbp-lightbox u-icon  rounded-circle">
                   				 	<img class="u-avatar rounded-circle mr-3" src="<?php echo $thumbFlag;?>" alt="<?php echo $alt;?>">
                  					</a>
                				</li>
              				</ul>
            			</div>
        		...
        		<div class="p-4">
          			...
          			<small class="d-block text-muted mb-2">Ubicación de destino en: <?php echo travelmate_get_terms( $post->ID, 'ubicacion_destinos' );?></small>
        		</div>
    		</div>
